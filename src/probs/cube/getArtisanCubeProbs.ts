...
const getArtisanCubeRankUpProbs = async (isMiracle?: boolean, date?: Date | fullUuidInfo) => {
...
const getArtisanCubeOptionProbs = async (isMiracle?: boolean, date?: Date | fullUuidInfo) => {
